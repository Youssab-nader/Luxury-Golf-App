      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(
            name: AppRouts.fix,
            path: AppRouts.fix,
            builder: (context, state) => const FixScreen(),

            routes: [
              GoRoute(
                name: AppRouts.checkOutRepairDetails,
                path: '${AppRouts.fix}/${AppRouts.checkOutRepairDetails}',
                builder: (context, state) => CheckOutRepairDetails(),
              ),

              GoRoute(
                name: AppRouts.checkOutRepairCustomerInfo,
                path: '${AppRouts.fix}/${AppRouts.checkOutRepairCustomerInfo}',
                builder: (context, state) => const CheckOutRepairCustomerInfo(),
              ),

              GoRoute(
                name: AppRouts.checkOutRepairConfirm,
                path: '${AppRouts.fix}/${AppRouts.checkOutRepairConfirm}',
                builder: (context, state) => const CheckOutRepairConfirm(),
              ),
              ...
              GoRoute(
                ...
                path: '${AppRouts.fix}/${AppRouts.fixHistory}',
